        ...
        <div class="row grid-margin">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    {{Form::open(['action' => 'ProduitController@editProduit' ,
                    ...
                    {{-- <form class="cmxform" id="commentForm" method="get" action="#"> --}}
                        <fieldset>
                            <div class="form-group">
                                ...
                                <input id="cname" class="form-control" name="id" minlength="2" type="hidden" value="{{$products->id}}" required>
                            </div>
                            <div class="form-group">
                                <label for="cname">Prix</label>
                                <input id="cname" class="form-control" name="price" minlength="1" type="text" value="{{$products->price}}" required>
                            </div>
                            <div class="form-group">
                                <label for="cname">Categorie</label>
                                    <?php
